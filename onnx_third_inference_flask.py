...
def onnx_search_and_run_third_half(onnx_models_path, onnx_model_file, data, results_file, EP_list, device = None):
  '''
  ...
  if onnx_model_file == None:
    for dir in os.listdir(onnx_models_path):
      if dir.find("_on_") > 0:
        ...
        if d == input_layer:
          #print("Found Layer: " + d)
          onnx_file = onnx_models_path + "/" + dir + "/third_half.onnx"
          break
